...
class _FirstChangePassScreenState extends State<FirstChangePassScreen> with ThemeDataMixin {
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFieldCustom(
                        ...
                        validate: (value) => ct.validate.validateConfirmPass(value, ct.newpassEditingController.text),
